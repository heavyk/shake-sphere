...
jesus however adds an extra set of hands, so now that makes a total of 33 or 90 numbers. thing is though, jesus is always givin it 110% (all of the time), then which
