...
- *LL*: *will* + *IAM*. the *disposition* of someone in both *manner* and *form* following represented in a positive/emitter way: the *lion*. (also, 11,11 in gematria) [FIXME]
...
- *eyes*: a receptive *organ* of *images* coming from the exterior world. also, when when a woman climaxes (not sure about men), an enormous amount of light comes out of her *eyes* and *eye*.
- *eye*: the mind's *eye* (or third *eye*), which receives the *image* from the *inner-world* or *under-world*. when referring to a woman, the *eye* is the vagina (along with its *brow*). the *eye* lights up with *fire*, illuminating the *inner-world* usually by a *torch*.
...
- *torch*: penis. has a feeling of warmth and also gives light.
- *torchbearer*: someone who bears a *torch*
- *cousin*, *coz*: can be a blood relationship, but usually a reference to undeserved/unmerited wealth or conditions: nepotism. (nepot is cousin in latin)
- *narrow*: usually referring to *seas* or *streets*, where the narrow one is a vagina, and a wide one is an anus. (usually found in context of troubles of selection depending on *humour* or *disposition*)
- *rialto*: rio+alto = high rivers; waters of noblility, or someone of noble character [the image is something of gossip or sexual exploits of important/notable people.]
- *port*: vagina; and referring to *sport*
...
- *venice*: V-nice. [on the map of italy, venice is the innermost part of a long canal in the back]
- *mantua*: your man, or the getting of or possessing of the man (marriage). in spanish, man-tuya is literally "your man".
- *padua*: [not totally sure about this one, but all of the imagery is of gay sex. on the map of italy, it's just to the left of venice, so maybe I'm thinking prostate?] (benedick is from padua)
	- [to be completely honest, I don't understand the symbolism, because petruchio *will* to *venice*, but gets caught instead in *padua* -- inotherwords, he's opting for a man's love instead of a woman's, but going for top he ends up bottom?]
...
- gratiano: gratis+ano = free anus; or, a bottom that is quite liberal and doesen't charge money.
- bassanio: low+(giver to / user of anus); the top/soldier -- but also has the secondary meaning of being the *base* or immature one. [the double-meaning occurs, because in alchemy, the "base" is the metal being worked on, and is usually the bottom, or more sensitive *metal*; however, if the top/emitter/charactor/noble metal is paired with a particularly dull/insensitive ground/actor/base metal (like gratiano), then the noble metal, being more sensitive than the base, is affected more -- therefore the alchemical process is to amplify the charactor/noble metal, to such a point that the base metal becomes the more sensitive one. the aplification is performed by the reflector, which is often times the woman (portia). in JC, because brutus rejuscts portia, cassius (who would traditionally be the base) amplifies the reflection of brutus (who would be the charactor) to such a degree that he sees his own unworthiness]
- portia: giver to / user of port [it seems to me that since portio would be the masculine version of her, but because port seems to be referring 
